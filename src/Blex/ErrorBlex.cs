...
/// <see cref="BlexOptions.OnError"/> / <see cref="BlexManager.OnError"/>; when no handler is
...
public readonly record struct BlexError(string Source, Exception Exception, string? Detail = null);
